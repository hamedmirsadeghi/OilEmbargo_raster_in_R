...
#$ -pe smp 26            # Request 17 processor cores
#$ -l h_vmem=10G         # Request 2GB of RAM per core used (4GB total)
#$ -l h_rt=48:00:0       # Max. run time of 3 days
